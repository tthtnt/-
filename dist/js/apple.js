...
window.onscroll = function () {
  if (getScroll().top > my$("first-div").offsetHeight){
    my$("second-nav").className = "second-nav fixed";
    my$("apple-banner").style.marginTop = my$("second-nav").offsetHeight + "px";
  }else{
    my$("second-nav").className = "second-nav";
    my$("apple-banner").style.marginTop ="0";
  }
};
